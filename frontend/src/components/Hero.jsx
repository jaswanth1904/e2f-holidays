...
const Hero = () => {
    ...
    const [heroData, setHeroData] = useState({
        ...
        subheading: "Just pack and go, leave the rest to us.",
        images: heroImages
    });
            ...
            try {
                ...
                if (data) {
                    setHeroData({
                        ...
                        subheading: data.heroSubheading || "Just pack and go, leave the rest to us.",
                        images: data.heroImage ? [data.heroImage, ...heroImages.slice(1)] : heroImages
                    });
                }
            } catch (error) {
        ...
        <div className="relative w-full h-screen flex flex-col justify-center items-center text-center pt-[120px] bg-black overflow-hidden transform-gpu">
            ...
            <div className="absolute inset-0 w-full h-full">
                <AnimatePresence mode="sync">
                    ...
                    >
                        <img
                            src={optimizeImage(heroData.images[currentImage], 1200)}
                            srcSet={`
                                ${optimizeImage(heroData.images[currentImage], 600)} 600w,
                                ${optimizeImage(heroData.images[currentImage], 1000)} 1000w,
                                ${optimizeImage(heroData.images[currentImage], 1200)} 1200w
                            `}
                            sizes="100vw"
                            width="1200"
                            height="700"
