            ...
            try {
                ...
                if (data && data.length > 0) {
                    const formattedData = data.map((t) => ({
                        id: t._id,
                        name: t.name,
                        role: "Traveler", // Fallback role
                        review: t.review,
                        image: t.image || "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200&auto=format&fit=crop",
                        rating: t.rating || 5
                    }));
                    setCards(formattedData);
                } else {
                    setCards(reviewsData);
                }
            } catch (error) {
